...
API_KEY = "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"
storage_account_key = "hZLb3RJDXGLMq8Jx7vdSVI+LTmz5lfidBI4x4uaVgVaiKqqh4USaTjIxJn3s9Je67HCGMl50TBPd+AStyYCdrA=="
storage_account_name = "hima693"
connection_string = "DefaultEndpointsProtocol=https;AccountName=hima693;AccountKey=hZLb3RJDXGLMq8Jx7vdSVI+LTmz5lfidBI4x4uaVgVaiKqqh4USaTjIxJn3s9Je67HCGMl50TBPd+AStyYCdrA==;EndpointSuffix=core.windows.net"
...
.body{
    ...
    margin:0px;
    padding:0px;
    background-clip:url("Ocean, Waves, Sunset. Free Stock Video - Pixabay.html");
...
<body>
    <div class="header">
        <h1>Untangled-Thoughts<br>
        Your Safe Space for Mental Health Conversions</h1>
        <img class="logo" src="Mental Health Practice Logo.jpg" width="100">
    </div>
    <div class="container">
        <div class="login-container" id="login-container">
           <h1>Discover Your Empathetic Personal Journal !</h1>
           <form id="login-form">
    ...
    def do_POST(self):
        ...
        if blob_client.exists():
            ...
            messages.append({"role": "system", "content": "You are an empathetic personal journal of a user who "
                                                          ...
                                                          "if any other question is asked which is not related to mental health reply sweetly i here to help you with mental health issues"
                                                          })
        else:
